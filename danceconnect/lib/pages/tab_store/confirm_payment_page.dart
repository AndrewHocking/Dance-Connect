...
class _ConfirmPaymentPageState extends State<ConfirmPaymentPage> {
  ...
  Map setOrderPaymentObjectOneTime(String orderId, List shippingDetails,
      StoreModel storeModel, int itemCount) {
  ...
  _payNowOneTimePayment() {
    PayHere.startPayment(
      ...
      setState(() {
        ...
        CWMessagePopups(message: 'Payment Failed')
            .cwAlertDialogLoading(context, false, errorMessage, () {
      ...
      CWMessagePopups(message: 'Payment Dismissed')
          .cwAlertDialogLoading(context, false, errorMessage, () {
        Navigator.of(context).pop();
      }, 'assets/icons/icons8_high_priority_50px.png');
    });
