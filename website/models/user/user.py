...
class Notification(db.Model):
    ...
    recipient: Mapped['User'] = relationship('User', foreign_keys=[recipient_id], backref="received_notifications")
    sender: Mapped['User'] = relationship('User', foreign_keys=[sender_id], backref="sent_notifications")  
...
class EventRequestNotification(Notification):
    ...
    id: Mapped[int] = mapped_column(Integer, ForeignKey("notification.id"), primary_key=True)
    event: Mapped['Event'] = relationship('Event', back_populates="request_notifications")
