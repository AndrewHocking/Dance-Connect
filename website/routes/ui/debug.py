    ...
    posts = [
        {
            ...
            "description": "To achieve greatness. This is an objective that many have, but are unable to achieve. However, we will provide you with the chance to achieve just that through dance.",
            "responsibilities": "You must be willing to get along with a group of 5-6 other dancers as well as other staff members. Additionally, you must maintain a social media presence to grow both your own fandom as well as the company's fandom.",
            "requirements": "The applicant must have already danced as part of 5 previous public performances to have sufficient experience.",
            "compensation": "Approximately $3,500. This sum may grow if the final performances have exceptional ticket sales.",
            "additional_info": "Be confident.",
            "application_details": "Come to our location in-person, and you will be provided with a hard-copy of the application form.",
        },
        {
            ...
            "term_type": TermType.FULL_TIME,
            "number_positions": random.choice([None, 1, 2, 4, 8, 11]),
            "description": "In order to give back to the community, we will be organizing a non-profit event near the local elderly care center. We want to bring smiles to the individuals that have supported our community to have come as far as it has.",
            "responsibilities": "(1) Dance well, (2) Have friendly interactions with the seniors.",
            "requirements": "Have some prior experience in dance groups. You don't need to have any prior public dance experience though.",
            "compensation": "This event is non-profit, so successful applicants will be volunteers.",
            "additional_info": "Let's have fun together!",
            "application_details": "The application can be viewed in the link below.",
        ...
        },
        {
            ...
            "number_positions": random.choice([None, 1, 2, 4, 8, 11]),
            "description": "We will be auditioning for a summer outdoor dance event that will be taking place alongside the summer parade in a small neighborhood in the GTA",
            "requirements": "You must be willing to make frequent commutes to the GTA with a flexible schedule since many members are part-time, so scheduling conflicts are common.",
            "compensation": "For each week leading up to the final parade you will be paid $500. Additional compensation may be offered from parts of the sales from the final event.",
            "application_details": "2-Round Process: (1) Submit your portfolio and acceptable work hour/days. (2) In-person dance practice.",
            "application_link": "www.google.com",
        },
        {
            ...
            "pay": "$1,000",
            "number_positions": random.choice([None, 1, 2, 4, 8, 11]),
            "description": "Multi-week Intensive Program sure to jump start your ballet career!",
            "requirements": "A willingness to learn",
            "compensation": "We will be providing the few succecssful applicants with a $1,000 bursary to support their ventures as future dance talents.",
            "application_details": "No formal application is required, however registration will be done 2-hours beforehand.",
        },
        {
            ...
            "responsibilities": "(1) Hold classes form 9am-3pm from Monday-Friday. (2) Record student progress weekly. (3) Report progress to the National Ballet",
